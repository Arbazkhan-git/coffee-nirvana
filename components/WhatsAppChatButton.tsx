  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 hidden md:block">
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="group inline-flex items-center gap-3 rounded-full bg-olive px-5 py-3 text-sm font-semibold text-forest shadow-[0_12px_36px_-16px_rgba(32,58,40,0.95)] transition duration-200 hover:bg-forest hover:text-cream"
        aria-label="Chat on WhatsApp with Coffee Nirvana"
      >
        <span className="flex h-10 w-10 items-center justify-center rounded-full bg-forest text-cream shadow-sm">
